...
export default function Experience() {
  return (
    <section className="relative w-full min-h-screen flex items-center bg-black overflow-hidden border-t border-white/5 pt-20 md:pt-0">
            ...
            <div className="absolute top-1/2 right-0 -translate-y-1/2 md:top-1/3 z-0">
              <span className="kinetic-title text-watermark opacity-5">EXPERIENCE</span>
            </div>
              ...
              <MotionReveal className="w-full md:w-1/2 p-8 md:p-24 flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-8 mb-12">
                  <div className="flex items-start gap-4 border-l border-white/10 pl-6">
                    ...
                    <p className="text-white/60 text-lg font-proxima font-light leading-relaxed">Live sets from international underground masters.</p>
                  </div>
                  <div className="flex items-start gap-4 border-l border-white/10 pl-6">
                    <span className="text-white/30 font-sarpanch text-sm pt-1">02.</span>
                    <p className="text-white/60 text-lg font-proxima font-light leading-relaxed">Immersive audio-visual art installations.</p>
                  </div>
                  <div className="flex items-start gap-4 border-l border-white/10 pl-6">
                    <span className="text-white/30 font-sarpanch text-sm pt-1">03.</span>
                    <p className="text-white/60 text-lg font-proxima font-light leading-relaxed">A community of sound and soul.</p>
                  </div>
                </div>
                <div>
                    <Link
