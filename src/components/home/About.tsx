  ...
  return (
    <>
      <section id="culture" className="relative w-full bg-black overflow-hidden border-t border-white/5 py-24 md:py-28">
        <div className="absolute top-10 left-1/2 -translate-x-1/2 z-0 opacity-5 kinetic-title text-watermark whitespace-nowrap">
          ARCHIVE
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <MotionReveal className="mb-12 grid gap-7 md:grid-cols-[0.82fr_1.18fr] md:items-end">
            ...
            <div className="grid gap-5 border-l border-primary/50 pl-5 md:pl-7">
              ...
              <div className="flex flex-col gap-2 border border-primary/25 bg-primary/5 px-4 py-3 md:flex-row md:items-center md:justify-between">
                <div>
                  <span className="block font-sarpanch text-sm font-black uppercase tracking-[0.16em] text-primary">
                    BOOMBAP Radio
                  </span>
                  <p className="mt-1 font-proxima text-xs uppercase tracking-[0.18em] text-white/48">
                    Live from the culture
                  </p>
                </div>
                <p className="font-proxima text-xs uppercase tracking-[0.18em] text-white/62">
                  Podcasts / Live Sets / Cyphers
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                {culturePoints.map((item, idx) => (
                  <div key={item} className="border border-white/10 bg-white/2.5 p-3">
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <MotionReveal delay={0.24} className="grid h-full gap-6 lg:grid-rows-[1fr_auto]">
                <div className="relative flex min-h-112 overflow-hidden border border-primary/25 bg-white/2.5 p-7 md:p-8">
                  <span className="pointer-events-none absolute -right-4 bottom-0 font-sarpanch text-[9rem] font-black leading-none text-white/2.5 md:text-[12rem]">
                    DIR
                  </span>
